...
- 🎨 **Frontend Client (Next.js 14):** [github.com/MuradHasan49/MHS-Portfolio](https://github.com/MuradHasan49/MHS-Portfolio)
- ⚙️ **Backend API (Node.js & Express):** [github.com/MuradHasan49/MHS-Portfolio-Server](https://github.com/MuradHasan49/MHS-Portfolio-Server)
...
```
MHS-Portfolio / MHS-Portfolio-Server
├── backend/                  # API Server (https://github.com/MuradHasan49/MHS-Portfolio-Server)
│   ├── src/
...
│   └── package.json
│
└── client/                   # Web Client (https://github.com/MuradHasan49/MHS-Portfolio)
    ├── src/
...
git clone https://github.com/MuradHasan49/MHS-Portfolio-Server.git backend
cd backend
...
git clone https://github.com/MuradHasan49/MHS-Portfolio.git client
cd client
...
1. Set up a project on Vercel connected to the [MHS-Portfolio-Server](https://github.com/MuradHasan49/MHS-Portfolio-Server) repository.
...
1. Connect the [MHS-Portfolio](https://github.com/MuradHasan49/MHS-Portfolio) repository to Vercel as a Next.js project.
...
- **Live Site:** [muradhasan49.vercel.app](https://muradhasan49.vercel.app)
- **Frontend Repo:** [MHS-Portfolio](https://github.com/MuradHasan49/MHS-Portfolio)
- **Backend Repo:** [MHS-Portfolio-Server](https://github.com/MuradHasan49/MHS-Portfolio-Server)
- **GitHub Profile:** [@MuradHasan49](https://github.com/MuradHasan49)
